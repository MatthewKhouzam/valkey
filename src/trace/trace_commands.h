...
LTTNG_UST_TRACEPOINT_EVENT(
	...
	LTTNG_UST_TP_FIELDS(
		lttng_ust_field_enum_nowrite(valkey_commands, valkey_conn_type_enum, int, enum_field, prot)
		lttng_ust_field_string_nowrite(addr, addr)
		lttng_ust_field_string_nowrite(laddr, laddr)
		lttng_ust_field_string_nowrite(name, name)
	)
)
